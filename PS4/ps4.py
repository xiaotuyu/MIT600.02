...
class Patient(object):
    ...
    def update(self):
        ...
        population_density = len(new_bac)/self.max_pop
        for bac in new_bac:
            try:
                new_bac.append(bac.reproduce(population_density))
...
class TreatedPatient(Patient):
    ...
    def update(self):
        ...
        population_density = len(bacList)/self.max_pop
        for bac in new_bac:
            try:
                new_bac.append(bac.reproduce(population_density))
            except NoChildException:
...
def simulation_with_antibiotic(num_bacteria,
    ...
    for i in range(num_trials):
        ...
        patient = TreatedPatient(bacList, max_pop)
...
make_two_curve_plot(range(numStep), aveList1, aveList2, 'Total', 'Resistant', 'Average Population', 'Without Antibiotic', 'With an Antibiotic')