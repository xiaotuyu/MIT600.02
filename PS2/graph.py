...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        ...
        self.outdoor_distance = outdoor_distance  # TODO
    ...
    def __str__(self):
        return self.src.get_name() + '->' + self.dest.get_name() \
               ...
               + ', '+ str(self.outdoor_distance) +')'  # TODO
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        self.edges[src].append(WeightedEdge(src, dest, edge.get_total_distance(), edge.get_outdoor_distance()))   # TODO
